const proyectInfo = [
	...
	},
	{
		...
		description:
			'Esta App Web esta hecha sobre una "plantilla" de una lista de reproduccion de "Yoelvis Mulen { code }" sobre aprender React. <br/><br/> Lo modifique al agregarle Typescript utilizando Vite en el frontend, esta consume una api de <a style="color: #46ff57;" href="https://www.themoviedb.org/" target="_blank">TheMovieDB</a> para obtener los datos de las peliculas, utilizando Bootstrap 5 para facilitar el diseño y un poco de Sass para modificar un poco las variables de esta. Agrege un login, para que el usuario tenga las funcionalidades de un CRUD mediante listas de peliculas. Ademas utilize una libreria de notificaciones para informar al usuario de sus acciones.',
	...
	},
	{
		...
		description:
			'El codigo original de esta app no ha sido creada por mi, esta a sido modificada y refactorizada por mi. Mas info en el README del repositorio de este proyecto en github. <br/> <br/> Basicamente esta app utilizaba http para hacer el pedido al backend en PHP y lo cambie a Sockets con la libreria Reatchet, ademas queria usar POO por lo que pase mucha logia a Clases (ya que nunca lo habia utilizado), aunque lo hice sin mucha idea de las buenas practicas de POO en PHP <b> (me encuentro mejorando en el POO a la vez que estoy aprendiendo Laravel)</b>',
